      ...
      <section className=" hidden md:col-span-1 md:flex  lg:col-span-2  justify-center items-center">
        <div className="lg:w-[70%] px-5 space-y-10">
          <div className="borderr rounded-md space-y-2 font-bold text-center">
            <p className=" text-2xl">Become a Trusted Service Provider </p>
            <p className="text-lg text-teal-500"> Start Today!</p>
          </div>

          <img className="" src={"https://broomees.com/attachments/services/House%20Help-2.png"} alt="" />
          {/* <div>
                <p className=" logo absolute p-6 rounded-t-full text-white text-center top-0 left-16 right-11 bg-teal-500"></p>
            </div> */}
